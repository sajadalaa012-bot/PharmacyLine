...
const NAV: { href: string; label: MessageKey; icon: typeof Package }[] = [
  ...
  { href: "/admin/packages", label: "nav.packages", icon: Boxes },
  { href: "/admin/home", label: "nav.homeSlides", icon: GalleryHorizontal },
  { href: "/admin/wheel", label: "nav.wheel", icon: Gift },
