...
const SCHEMA_SQL = `
    ...
    CREATE TABLE IF NOT EXISTS packages (
      ...
      image_url      TEXT NOT NULL DEFAULT '',
      price          NUMERIC(14,2) NOT NULL DEFAULT 0,
      -- The struck-through "was" price. NULL is the normal case.
      old_price      NUMERIC(14,2),
      -- Off the storefront while false. A package starts hidden so a shopper
      -- never meets one before it has been priced and filled.
